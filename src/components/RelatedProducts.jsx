                    ...
                    <SwiperSlide key={index}>
                        <Link onClick={window.scrollTo(0, 0)} className='flexCenter gap-x-5 bg-white p-4 rounded-xl' to={`/product/${item.id}`}>
                            ...
                            <div className='flex flex-col gap-y-1'>
                                ...
                                <p className='line-clamp-1'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea nostrum error saepe. Est voluptas praesentium, saepe voluptatibus at totam repellat maxime suscipit quibusdam, quas, aspernatur quis fugiat recusandae temporibus ab.</p>
